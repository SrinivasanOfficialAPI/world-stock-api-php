...
$eftUrl = "funds-highest-diversification";
$totCol = 11;
$colArr = array("stockName", "topTenWeight", "price", "priceChange", "volumePrice", "relativeVolume", "assetsUnderManagement", "NAVTotalReturn", "expenseRatio", "assetClass", "focus");
