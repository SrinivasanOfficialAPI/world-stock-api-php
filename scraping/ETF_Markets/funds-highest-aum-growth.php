...
$eftUrl = "funds-highest-aum-growth";
$totCol = 11;
$colArr = array("stockName", "AUMPerformnce", "price", "priceChange", "volumePrice", "relativeVolume", "assetsUnderManagement", "NAVTotalReturn", "expenseratio", "asserRatio", "focus");
