...
$eftUrl = "funds-largest";
$totCol = 10;
$colArr = array("stockName", "assetUnderManagement", "price", "priceChange", "volumePrice", "relativeVolume", "NAVTotalReturn", "expenseRatio", "assetClass", "focus");
