...
$eftUrl = "funds-negative-beta";
$totCol = 11;
$colArr = array("stockName", "betaThreeYears", "price", "priceChange", "volumePrice", "relativeVolume", "assetsUnderManagement", "NAVTotalReturn", "expenseRatio", "assetClass", "focus");
