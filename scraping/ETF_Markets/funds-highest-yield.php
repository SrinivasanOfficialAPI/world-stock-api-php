...
$eftUrl = "funds-highest-yield";
$totCol = 11;
$colArr = array("stockName", "dividentYeild", "price", "priceChange", "volumePrice", "relativeVolume", "assetsUnderManagement", "NAVTotalReturn", "expenseRatio", "assetClass", "focus");
