...
$eftUrl = "funds-highest-returns";
$totCol = 10;
$colArr = array("stockName", "NAVTotalReturn", "price", "priceChange", "volumePrice", "relativeVolume", "assetsUnderManagement", "expenseRatio", "assetClass", "focus");
