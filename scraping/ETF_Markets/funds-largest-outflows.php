...
$eftUrl = "funds-largest-outflows";
$totCol = 11;
$colArr = array("stockName", "fundFlows", "price", "priceChange", "volumePrice", "relativeVolume", "assetsUnderManagement", "NAVTotalReturn", "expenseRatio", "assetClass", "focus");
